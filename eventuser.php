      ...
      if($fetch_dat->num_rows()>0)
      {
        foreach ($fetch_dat->result() as $row) {
          ...
          <tr>
            ...
            <td><a href="<?php echo base_url('index.php/Homec/adde'); ?>">add</a></td>
            <td><a href="<?php echo base_url('index.php/Homec/edite/'.$row->name); ?>">edit</a></td>
            <td><a href="<?php echo base_url('index.php/Homec/deletee/'.$row->name); ?>">delete</a></td>
          <?php }
          else
            {?>
              <td><a href="<?php echo base_url('index.php/Homec/addde/'.$row->name); ?>">add</a></td>
