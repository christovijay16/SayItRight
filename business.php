     ...
     <div class="nav">
        ...
        <div class="container">
          <img src="<?php echo base_url("home-banner.jpg"); ?>"  width="100%" height="200px">
              <div class="centered"><p style=" font-size: 12px;">Home <i class="fas fa-arrow-right"></i> BUSINESS</p><p>BUSINESS</p></div>
            </div>
      <div class="aboutus" style="width: 100%;margin-bottom: 250px;"><form action="" method="post">
       ...
       <div class="aboutstext" style="width: 50%;float: left; padding-left: 200px;">
          <p style="padding-left: 150px;">Select Type Of User</p>
           ...
           <p style="font-size: 10px;padding-left: 100px;">welcome to Business records</p>
             <p style="display:inline">type of Business</p> <input type="radio" name="bus" id="radio">university <input type="radio" name="bus"id="radio">company<span><?php echo form_error('bus'); ?> </span><br/><br/>
          <input type="text" name="lastname" id="lastname"placeholder="Enter Your Last Name"  style="width: 350px;height: 30px;"><br/><br/><span><?php echo form_error('lastname'); ?> </span>
           <input type="text" name="email" id="email"placeholder="Enter Email"  style="width: 350px;height: 30px;"><br/><br/><span id="showmessageB"></span><span><?php echo form_error('email'); ?> </span>
            <input type="text" name="password" id="password"placeholder="Enter password"  style="width: 350px;height: 30px;"><br/><br/><span id="showmessageC"></span><span><?php echo form_error('password'); ?> </span>
